...
<<<<<<< HEAD
ActiveRecord::Schema[7.0].define(version: 2022_11_26_125544) do
=======
ActiveRecord::Schema[7.0].define(version: 2022_11_26_134305) do
>>>>>>> master
  ...
  create_table "experiences", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["task_application_id"], name: "index_experiences_on_task_application_id"
  end
  ...
  add_foreign_key "experiences", "task_applications"
